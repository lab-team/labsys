...
class dao_MysqlModel {
    ...
    public function _initDb() {
        // $objConf = new Ap_Config_Ini(APP_PATH . "/conf/db.ini");
        // $arrConf = $objConf->toArray();
        // $_addr['host']=$arrConf['datatansfer']['host'];
        // $_addr['port']=$arrConf['datatansfer']['port'];
     ...
     * @return string
     */
    public function _addChar($value) {
     ...
     * @return array
     */
    public function _showAllTables($dbName = false) {
        if (false == $dbName) {
            $dbName = $this->_dbName;
        }
