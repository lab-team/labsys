...
<style>
    ...
    #shangceng{z-index:999; margin-left:220px;margin-top:0px;height:100%;}
</style>
		...
		<nav class="navbar navbar-static-top" role="navigation">
			...
			<div class="navbar-right">
				<ul class="nav navbar-nav">
					...
					<input type="submit" value="<?php echo check_week();?>" id="in" name="in" class="btn_bu" type="button" style="margin-top:0.35cm; background:<?php echo check_week_color();?>;width:150px;height:26px; font-family:微软雅黑;color:white;border:none; border-radius:2px;cursor:default;"> 	
    &nbsp;&nbsp;&nbsp;    <li class="dropdown messages-menu">
							<form action="stuReg.php" method="get">
						<input type="submit" value="<?php echo check_reg();?>" id="reg_in" name="reg_in" class="btn_bu" type="button" <?php echo click_not();?> style="margin-top:0.35cm; background:<?php echo reg_color(); ?>;width:80px;height:26px; font-family:微软雅黑;color:white;border:none; border-radius:2px; cursor:pointer;	
  "></submit>
                    </form>
					<?php
					//对每月签到信息进行删除
										...
										<!-- Task item --> <a href="#">
											...
											<div class="progress xs">
												<div class="progress-bar progress-bar-aqua"
													style="width: <?php echo $row['process'];?> " role="progressbar" aria-valuenow="50"
													aria-valuemin="0" aria-valuemax="100">
													<span class="sr-only"><?php echo $row['process'];?> Complete</span>
												</div>
											</div>
									</a>
									</li>
				...
				<li class="dropdown user user-menu"><a href="#"
					...
					<ul class="dropdown-menu">
						...
						<li class="user-header bg-light-blue"><img src="<?php echo $face_url; ?>"
							...
							<p>
								<?php echo $china_name; ?><small>Member since Nov. 2017</small>
							</p></li>
						<!-- Menu Body -->
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                 <li><a href="#" onclick="changeit('TaskDetail.php')"><i class="fa fa-angle-double-right"></i>查看任务</a></li>
                                 <li><a href="#" onclick="changeit('addTask.php')"><i class="fa fa-angle-double-right"></i> 添加任务</a></li>
                           
                                <li><a href="#" onclick="changeit('inquireTask1.php')"><i class="fa fa-angle-double-right"></i> 修改任务</a></li>
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href="#" onclick="changeit('write.php')" ><i class="fa fa-angle-double-right"></i> 添加周报</a></li>
                                <li><a href="#" onclick="changeit('week.php')"><i class="fa fa-angle-double-right"></i> 查看周报</a></li>
                                <li><a href="#" onclick="changeit('inquireWeek.php')"><i class="fa fa-angle-double-right"></i> 修改周报</a></li>
